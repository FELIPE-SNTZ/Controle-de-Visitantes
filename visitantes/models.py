...
class Visitante(models.Model):
    ...
    horario_autorizacao =models.DateTimeField(verbose_name='Horário da Autorização de Entrada',auto_now_add=False, blank=True,null=True)
    horario_saida = models.DateTimeField(verbose_name='Horário de Saida do Condomínio',auto_now_add=False, blank=True,null=True)
